...
class JsWork9 extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
        };
  ...
  fixNav(){
    const body = document.querySelector('.jswork9');
    if(window.scrollY >= this.topOfNav){
      body.style.paddingTop = this.nav.offsetHeight+'px';
    ...
    //console.log(this.topOfNav,window.scrollY);
  }
